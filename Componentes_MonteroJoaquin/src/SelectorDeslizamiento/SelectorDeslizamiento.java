/*
    ...
    Se incorpora en mis componentes.
    En esta aplicación implementa la vista, usando SceneBuilder, 
    que incluya dos selectores de este tipo, ambos en un VBox. Además habrá una
    etiqueta que recibirá el texto "Pulsado el selector de arriba" cuando se pulse el de arriba y recibirá el
    texto "Pulsado el selector de abajo".
 */
