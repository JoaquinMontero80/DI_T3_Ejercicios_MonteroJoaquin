/*
    Joaquin Montero. 2DAM. DI --> CheckBoxSample con CSS.
        Modificar la apariencia del control Tooltip implementando los pasos
        indicados en el tutorial referenciado: 
...
public class CheckboxSample extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Llamada a CSS ( establece una X al pulsar la casilla de verificacion )
        scene.getStylesheets().add("checkboxsample/checkbox.css");
