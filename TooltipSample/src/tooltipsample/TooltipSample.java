/*
    Joaquin Montero. 2DAM. DI --> Tooltip con CSS.
...
public class TooltipSample extends Application 
{
    ...
    public void start(Stage stage) 
    {
        ...
        // Llamada a CSS ( Cambio del color de fondo de una descripción emergente )
        scene.getStylesheets().add("tooltipsample/ToolTip.css");
